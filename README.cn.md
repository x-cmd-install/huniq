...
![huniq](https://repo.x-cmd.io/huniq.svg?lang=zh)
...
在 [repology.org](https://repology.org/project/huniq) 上共有 **8** 个发行版报告此项目。**7** 个 ✅ 已是最新上游版本，**0** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260911.yml` · 2026-09-11T04:34:45Z._
